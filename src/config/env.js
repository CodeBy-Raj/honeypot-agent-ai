...
export const TANAOS_API_KEY_1 = process.env.TANAOS_API_KEY_1;
export const TANAOS_API_KEY_2 = process.env.TANAOS_API_KEY_2;
export const TANAOS_API_KEY_3 = process.env.TANAOS_API_KEY_3;
